    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w-[20ch]  reveal-up">
          Let's Work Together!
          </h2>

          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[50ch]  reveal-up">
          If you're looking for a motivated individual with a strong foundation in web development, problem-solving, and database management, 
          I&apos;d love to connect! Feel free to reach out via the form below or contact me directly through email or LinkedIn.
          </p>
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon, alt }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 text-zinc-50 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up"
              >
                {icon}
              </a>
            ))}
        ...
        <form action="https://getform.io/f/avrwekna" 
        method="POST" 
